...
export default {
  ...
  data() {
    return {
      items: [
  { Driver: 'Samppa Nori', Duration: '1 Hour', Passenger: 'Mark Roe', Trip_Status: 'Active'},
  { Driver: 'Estavan Lykos',Duration : '30 Min', Passenger:'Mole bloom', Trip_Status: 'Active'},
  { Driver: 'Chetan Mohamed', Duration: '15 Min', Passenger: 'Sandy rocher', Trip_Status: 'Active'},
  { Driver: 'Derick Maximinus', Duration: '50 Min',Passenger: 'lina Ali', Trip_Status: 'Active'},
  { Driver: 'Friderik Dávid', Duration: '2 Hour',Passenger: 'jack mayo', Trip_Status: 'Active'},
  { Driver: 'Yiorgos Avraamu', Duration: '3 Hour',Passenger: 'Member', Trip_Status: 'Active'}
  ],
      fields: [
        { key: "Driver", label: "Name", _classes: "font-weight-bold" },
        { key: "Duration" },
        { key: "Passenger" },
        { key: "Trip_Status" },
      ],
