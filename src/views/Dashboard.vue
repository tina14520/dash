  ...
  <div>
    <CRow>
      ...
      <CCol sm="2" md="2">
        <CWidgetProgressIcon
          header="385"
          text="•	Number of completed trips"
      ...
      <CCol sm="2" md="2">
        <CWidgetProgressIcon
          header="5:34:11"
          text="•	Number of disabled vehicle"
    ...
    >
      <template #status="{item}">
        <td>
          <CSwitch class="mx-1" color="primary" data-checked="On" data-unchecked="Off" :checked="item.status == 1 ? true : false" variant="3d" />
        </td>
      </template>
...
export default {
  ...
  data() {
    return {
      // selected: 'Month',
      items: usersData,
        fields:[ { key: 'username', label: 'Name', _classes: 'font-weight-bold' },
        { key: 'registered' },
        { key: 'role' },
        { key: 'status' }],
      tableItems: [
