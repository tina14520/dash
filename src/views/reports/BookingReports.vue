                        ...
                        <div class="row search-row">
                            <div class="col-4">
                                <div class="search-content">
                                    <FormulateInput type="text" placeholder="Search by id" name="searchById" v-model="searchById"/>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="search-content">
                                    <FormulateInput type="text" placeholder="Search by driver name" name="searchByName" v-model="searchByName" />
                                </div>
                            </div>
                        ...
                        <tr v-for="(trip, index) in trips" :key="index">
                            ...
                            <td>
                                <div class="table-icons">
                                    <div class="map-icon table-icon" @click="showMapModal(trip)" content="Show trip path" v-tippy="{ placement: 'left' }">
                                        <CIcon name="cil-location-pin" fill="#717171" class="side-icon"></CIcon>
                                    </div>
                                    <div class="info-icon table-icon" @click="showInfoModal(trip)" content="Show more details" v-tippy="{ placement: 'left' }">
                                        <CIcon name="cil-notes" fill="#717171" class="side-icon"></CIcon>
                                    </div>
                                </div>
                            </td>
                        </tr>
